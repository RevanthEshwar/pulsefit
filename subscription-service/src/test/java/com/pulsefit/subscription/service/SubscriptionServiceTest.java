...
class SubscriptionServiceTest {
    ...
    void getSubscriptionsByMember_shouldReturnSubscriptions() {
        ...
        var result =
                subscriptionService.getSubscriptionsByMember(1L);
    ...
    void getSubscriptionsByPlan_shouldReturnSubscriptions() {
        ...
        var result =
                subscriptionService.getSubscriptionsByPlan(1L);
    ...
    void updateSubscription_shouldUpdatePersonalTrainer() {
        ...
        updated.setStartDate(LocalDate.of(2026, 9, 17));
        updated.setEndDate(LocalDate.of(2027, 3, 17));
        ...
        assertTrue(result.getPersonalTrainer());
